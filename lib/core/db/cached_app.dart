enum CachedDataType { categories, humanitarianCases, profile, product, orders, categoriesWithProducts }

class CachedKeys {
  static Map<String, int> expirationCacheTime = {
    CachedDataType.categories.name: 600000,
    CachedDataType.humanitarianCases.name: 600000,
    CachedDataType.profile.name: 600000,
    CachedDataType.product.name: 600000,
    CachedDataType.orders.name: 600000,
    CachedDataType.categoriesWithProducts.name: 600000
  };
}
