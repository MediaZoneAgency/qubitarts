    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          CustomServiceImage(serviceImage: 'assets/images/adds.png',),
          Padding(
            padding: EdgeInsetsDirectional.only(
            ...
            builder: (context, state) {
              return SizedBox(
                ...
                child: ListView.separated(
                      ...
                      return Container(
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage(
                                  AdsCubit.get(context).pervious[index],
                                ),
                                fit: BoxFit.cover),
                            boxShadow: [
                              BoxShadow(
                    ...
                    itemCount: AdsCubit.get(context).pervious.length),
              );
            },
          ),
          Padding(
            ...
            child: AppTextButton(
              ...
              onPressed: () {
                context.pushNamed(Routes.AdsScreen);
              },
