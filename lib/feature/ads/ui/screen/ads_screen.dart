...
import '../widgets/ads_Request_states_ui.dart';
                  ...
                  return AdsCubit.get(context).currentPageIndex == 4
                      ...
                      : Container(
                          margin: EdgeInsets.only(
                              bottom: 24.h, left: 26.w, right: 26.w),
                          decoration: BoxDecoration(
                        ...
                        child: AppTextButton(
                          ...
                          onPressed: () {
                            if (AdsCubit.get(context).checkSendRequest()) {
                              ...
                              //     Routes.addAdsFinalScreen);
                               AdsCubit.get(context).addAdsRequest();
                            } else {
                              return showSnackBar(
                                  context: context,
                                  text: S.of(context).Allfieldmustnotbeempty,
                                  color: Colors.red,
                                  style: TextStyles.inter12SemiBoldWhite);
                            }
