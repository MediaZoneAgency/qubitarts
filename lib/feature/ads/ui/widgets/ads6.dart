...
class Ads6 extends StatelessWidget{
  @override
                ...
                //crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    ServiceRequestCard(
                      ...
                      id: 1.toString(),
                      title: AdsCubit.get(context).adsRequestModel.type??'',
                      startDate: DateFormat('dd MMM yyyy').format((AdsCubit.get(context).adsRequestModel.createdTime!)).toString()??"",
                      status: AdsCubit.get(context).adsRequestModel.status??'',
