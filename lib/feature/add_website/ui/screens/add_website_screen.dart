      ...
      body: ListView(
        children: [
          ...
          Container(
            width: 324.w,
            height: 211.h,
            child: Image.asset('assets/images/addwebsite.png'),
            color: Colors.white.withOpacity(0.1), // Adjust transparency
          ),
          Padding(
            padding: EdgeInsetsDirectional.only(
            ...
            builder: (context, state) {
              return SizedBox(
                ...
                child: ListView.separated(
                      ...
                      return Container(
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage(
                                  AddWebsiteCubit.get(context).pervious[index],
                                ),
                                fit: BoxFit.cover),
                            boxShadow: [
                              BoxShadow(
                    ...
                    itemCount: AddWebsiteCubit.get(context).pervious.length),
              );
            },
          ),
          Padding(
            ...
            child: AppTextButton(
              ...
              onPressed: () {
                context.pushNamed(Routes.businessDetails);
              },
