...
class _BusinessDetails2State extends State<BusinessDetails2> {
  ...
  void initState() {
    ...
    controller.addListener(() {
      AddWebsiteCubit.get(context).businessDescription = controller.text;
    });
  }
        ...
        children: [
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            builder: (context, state) {
              return ChooseBetween(selectedValue:AddWebsiteCubit.get(context).isNew, onSelect: (String isYesSelected) {  AddWebsiteCubit.get(context).toggleState(isYesSelected);}, choices: ['New','Old'],);
            },
          ),
            Divider(
            ...
            Column(
              ...
              children: [
                ...
                verticalSpace(20.h),
          CustomDescribtionTextField(hintText: S.of(context).TypeHere,backgroundColor: Color(0xffF9F9F9),borderColor:Color(0xffE4E4E4) ,containerHeight: 81.h,textStyle: TextStyles.inter25SemiBoldBlack.copyWith(fontSize: 14.sp),borderRadius: 11.r,controller: controller,),
              ],
            )
          ]),
        ],
