...
class MotionGraphicScreen extends StatelessWidget {
  const MotionGraphicScreen({super.key});
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          CustomServiceImage(serviceImage: 'assets/images/motion-graphic.png',),
          Padding(
            padding: EdgeInsetsDirectional.only(
            ...
            builder: (context, state) {
              return SizedBox(
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        decoration: BoxDecoration(
                            image: DecorationImage(image: AssetImage(MotionGraphicCubit.get(context).pervious[index],),fit: BoxFit.cover
                            ),
                    ...
                    itemCount: MotionGraphicCubit.get(context).pervious.length),
              );
            },
          ),
          Padding(
            ...
            child: AppTextButton(
              ...
              onPressed: () {
                context.pushReplacementNamed(Routes.addMotionGraphicScreen);
              },
