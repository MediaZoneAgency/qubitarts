...
class MotionGraphic6 extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocBuilder<MotionGraphicCubit,MotionGraphicState>(
            ...
            //crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                ServiceRequestCard(
                  ...
                  id: 1.toString(),
                  title: MotionGraphicCubit.get(context).motionGraphicModel.type!,
                  startDate: DateFormat('dd MMM yyyy').format((MotionGraphicCubit.get(context).motionGraphicModel.createdTime!)).toString(),
                  status: MotionGraphicCubit.get(context).motionGraphicModel.status!,
