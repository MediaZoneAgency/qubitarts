...
class AddMotionRequestStateUi extends StatelessWidget {
  const AddMotionRequestStateUi({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<MotionGraphicCubit,MotionGraphicState>(
      listener: (context, state) async {
        ...
        // Handle LoginSuccess state
          ...
          context.pushReplacementNamed(Routes.addMotionGraphicFinalScreen);
        }
