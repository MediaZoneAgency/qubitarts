...
class PrintOutScreen extends StatelessWidget {
  const PrintOutScreen({super.key});
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          CustomServiceImage(serviceImage: 'assets/images/print-out.png',),
          Padding(
            padding: EdgeInsetsDirectional.only(
            ...
            builder: (context, state) {
              return SizedBox(
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        decoration: BoxDecoration(
                            image: DecorationImage(image: AssetImage(PrintOutCubit.get(context).pervious[index],),fit: BoxFit.cover
                            ),
                    ...
                    itemCount: PrintOutCubit.get(context).pervious.length),
              );
            },
          ),
          Padding(
            ...
            child: AppTextButton(
              ...
              onPressed: () {
                context.pushReplacementNamed(Routes.addPrintOutScreen);
              },
