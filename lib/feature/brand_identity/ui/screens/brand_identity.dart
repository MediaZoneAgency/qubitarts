    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          CustomServiceImage(serviceImage: 'assets/images/brand-Id.png',),
            ...
            builder: (context, state) {
              return SizedBox(
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        decoration: BoxDecoration(
                            image: DecorationImage(image: AssetImage(BrandIdentityCubit.get(context).pervious[index],),fit: BoxFit.cover
                            ),
                    ...
                    itemCount: BrandIdentityCubit.get(context).pervious.length),
              );
            },
          ),
          Padding(
            ...
            child: AppTextButton(
              ...
              onPressed: () {
                context.pushNamed(Routes.addBrandIdentityScreen);
              },
